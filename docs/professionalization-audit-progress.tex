...
items are addressed below; the parity-test item remains open.
...
\begin{enumerate}[leftmargin=*]
  ...
  \item Fix the no-op optimized/reference toggles in the specieswise-uniform
        GPU parity test or retitle it as a smoke test with a separate parity
        check.
