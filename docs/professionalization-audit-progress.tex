...
specieswise-uniform GPU parity test.  The README workflow and pytest marker
items are addressed below, and the specieswise GPU test was retitled as honest
smoke/invariant coverage.
