...
specieswise-uniform GPU parity test.  The pytest marker item is addressed
below; the README and parity-test items remain open.
...
\begin{enumerate}[leftmargin=*]
  ...
  \item Add a README HOGENOM workflow matrix explaining the installed CLI,
        curated W\&B launcher, Hydra launcher, checkpoint export, and profiling
        harness.
