...
def pi_wave_forward(
    ...
    *,
    ...
    if use_exact_self_loop:
        ...
        # Five slots: the elimination's three affine coefficients per species plus the two
        # ancestor-sum components (see ``_exact_tree_pi_self_loop_kernel``'s slot table).
