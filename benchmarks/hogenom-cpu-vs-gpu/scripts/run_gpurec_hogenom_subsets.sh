...
GPUREC_ROOT="${GPUREC_ROOT:-$REPO_ROOT}"
PYTHON="${PYTHON:-python3}"
PREPROCESS_SO="${PREPROCESS_SO:-$GPUREC_ROOT/crates/gpurec-preprocess/target/release/libgpurec_preprocess.so}"
DRIVER="${DRIVER:-$HERE/run_gpurec_traced.py}"                 # the faster recipe, by default
FAM1055="$GPUREC_ROOT/experiments/sanderson_cv/families_1055.txt"

export PYTHONPATH="$GPUREC_ROOT:$GPUREC_ROOT/experiments/sanderson_cv"
